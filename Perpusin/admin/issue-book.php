...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['issue'])) {
        ...
        $copy = $result2[0]['numberCopy'];
        if($copy > 1){
            $studentid = strtoupper($_POST['studentid']);
            $bookid = $_POST['bookdetails'];
            $returnstatus = 0;
            $sql = "INSERT INTO  tblissuedbookdetails(StudentID,BookId,RetrunStatus) VALUES(:studentid,:bookid, :returnstatus)";
            $query = $dbh->prepare($sql);
            $query->bindParam(':studentid', $studentid, PDO::PARAM_STR);
            $query->bindParam(':bookid', $bookid, PDO::PARAM_STR);
            $query->bindParam(':returnstatus', $returnstatus, PDO::PARAM_STR);
            $query->execute();
            $sql1 = "UPDATE tblbooks SET numberCopy=numberCopy-1 WHERE (id = :bookid)";
        ...
        // if ($lastInsertId) {
        //     $_SESSION['msg'] = "Buku berhasil dipinjam";
        //     header('location:manage-issued-books.php');
        // } else {
    ...
    <div class=" content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Tambah Peminjaman</h4>
...
<div class=" panel panel-info">
                    ...
                    <div class="panel-body">
                        <form role="form" method="post">
                            ...
                            <button type="submit" name="issue" id="submit" class="btn btn-info">Tambah</button>
